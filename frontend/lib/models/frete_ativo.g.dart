...
FreteAtivo _$FreteAtivoFromJson(Map<String, dynamic> json) => FreteAtivo(
  ...
  latitudeAtual: (json['latitude_atual'] as num?)?.toDouble(),
  longitudeAtual: (json['longitude_atual'] as num?)?.toDouble(),
  enderecoAtual: json['endereco_atual'] as String?,
  ultimaAtualizacaoLocalizacao: json['ultima_atualizacao_localizacao'] == null
      ? null
      : DateTime.parse(json['ultima_atualizacao_localizacao'] as String),
);

Map<String, dynamic> _$FreteAtivoToJson(
  FreteAtivo instance,
) => <String, dynamic>{
  'id': instance.id,
  ...
  'latitude_atual': instance.latitudeAtual,
  'longitude_atual': instance.longitudeAtual,
  'endereco_atual': instance.enderecoAtual,
  'ultima_atualizacao_localizacao': instance.ultimaAtualizacaoLocalizacao
      ?.toIso8601String(),
};
